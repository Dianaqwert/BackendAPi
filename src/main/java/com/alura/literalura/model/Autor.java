...
public class Autor {
    ...
    public String toString() {
        ...
        return String.format("_________________ AUTOR ________________%nNombre:" +
                " %s%n%s%nNACIO: %s%nMURIO:" +
                " %s%n***************************%n",nombre,librosStr.toString(),fecha_nacimiento,getFecha_deceso());
    }
